...
var index = /*#__PURE__*/Object.freeze({
    ...
    attributeExistsInElement: attributeExistsInElement,
    getElement: getElement,
    getSelector: getSelector,
    removePiiFromUrl: removePiiFromUrl,
    ClearableWeakMap: ClearableWeakMap
});
...
function getUserKey$1() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { UserDataRequest } = yield import('https://assets.acdn.no/pkg/@amedia/user/v0/user.js');
...
function getCommon$1() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { getBrowserId, getVisitId } = !isLocalHost$1
            ? yield import('https://assets.acdn.no/pkg/@amedia/browserid/v1/index.js')
    ...
    elementSet.forEach((element) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (itemType.startsWith("https://www.adplogger.no/json-schema/meta")) {
            ...
            try {
                ...
                microdata.id = v4();
                const { default: data } = yield import(`./schemas/${schemaName}.js`);
...
export { init, rpcServer, index as utils };
